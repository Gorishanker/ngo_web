...
<div class="grid grid-cols-12 gap-5 mt-5">
    ...
    <div class="col-span-12 form-group xl:col-span-6">
        <label class="required">{{ trans_choice('content.country', 1) }}</label>
        {!! Form::text('country', null, [
            'class' => 'input w-full border bg-gray-100 mt-2',
            'placeholder' => trans_choice('content.country', 1),
        ]) !!}
         @if ($errors->has('country'))
         <span class="invalid-feedback" style="display: block;">{{ $errors->first('country') }}</span>
     @endif
    </div>
    <div class="col-span-12 form-group xl:col-span-6">
    ...
    <div class="col-span-12 form-group xl:col-span-4">
        <label class="required">{{ trans_choice('content.image', 1) }} (80*80px)</label>
        {!! Form::file('image', [
            'class' => 'input w-full border bg-gray-100 mt-2',
            'id' => 'image',
