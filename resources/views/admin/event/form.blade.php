...
<div class="grid grid-cols-12 gap-5 mt-5">
    ...
    <div class="col-span-12 form-group xl:col-span-6">
        <label class="required">{{ trans_choice('content.address', 1) }}</label>
    ...
    <div class="col-span-12 form-group xl:col-span-6">
        <label class="required">{{ trans_choice('content.date', 1) }}</label>
        {!! Form::text('date', null, [
            'class' => 'input w-full datepicker border bg-gray-100 mt-2',
            'placeholder' => trans_choice('content.date', 1),
        ]) !!}
    </div>
    <div class="col-span-12 form-group xl:col-span-6">
    ...
    <div class="col-span-12 xl:col-span-6 mt-4">
        @if (isset($event->image))
            <img id="backImage_image" width="80px" height="80px" src="{{ $event->image }}" title="Image">
            @else
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\EventRequest', 'form') !!}
@endpush
