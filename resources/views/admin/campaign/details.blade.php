...
@section('content')
        ...
        @if (isset($campaign->campaign_combos) && $campaign->campaign_combos->count())
            @foreach ($campaign->campaign_combos as $combo)
                <div class="intro-y col-span-12 lg:col-span-6">
                    <div class="intro-y box p-5">
                        <div>
                            <label class="text-gray-500 font-medium leading-none mt-3">Combo name
                                : </label>
                ...
                <div class="intro-y col-span-12 lg:col-span-6">
                    <div class="intro-y box p-5">
                        <div>
                            <label class="text-gray-500 font-medium leading-none mt-3">Combo price
                                : </label>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-2">
        <h2 class="text-lg font-medium mr-auto mt-3 mb-4">Reviews</h2>
    </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                oTable = $('#kt_table_1').DataTable({
                    ...
                    ajax: {
                        "url": "{{ route('admin.campaignReview.list') }}",
                        data: function(d) {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                ...
                                return ` <div class="text-center"> <a href="javascript:;" data-id="${row['id']}" data-status="${row['status']}" data-toggle="modal" data-target="#changeVerifyStatus" class="changeVerifyStatus button inline-block ${cls}  text-white">${status}</a> </div>`;
                            }
                        },
                        {
                            data: 'created_at',
                ...
                $(document).on('click', '.updateStatus', function() {
                    ...
                    var url = `{{ url('/') }}/admin/campaigns/review-verify-status/` + id + `/` + status;
